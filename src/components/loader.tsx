...
export function AppLoader() {
  ...
  return (
    <div
      ref={loaderRef}
      className="fixed inset-0 z-50 overflow-hidden cursor-pointer starry-loader-background"
      onClick={handleRippleClick}
      aria-label="Loading screen with interactive starry background"
      role="button"
      tabIndex={0}
    ...
    >
      <div className="relative z-20 flex flex-col items-center justify-center h-full">
        <div className="w-full max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg px-4 py-6 bg-black/60 rounded-xl shadow-2xl">
          <p className="text-xl sm:text-2xl font-semibold mb-4 text-center text-white">Welcome to Insightful</p>
